        ...
        <div class="dashboard-content">
            ...
            <!-- Search and Filter Section -->
                <div class="search-filter-card">
                    <h3>Search & Filter Inquiries</h3>
                    
                    <form method="GET" action="{{ route('admin.all.inquiries') }}">
                        <!-- Search Bar -->
                        <div class="search-row">
                            <input type="text" 
                                   name="search" 
                                   class="search-input" 
                                   placeholder="Search by title, content, or submitter name..." 
                        ...
                        <div class="filters-grid">
                            ...
                            <div class="filter-group">
                                <a href="{{ route('admin.all.inquiries') }}" class="btn btn-secondary">Clear All</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <form id="reminderForm" onsubmit="sendReminder(event)">
            ...
            <div class="form-group">
                ...
                <textarea
                    id="reminderMessage"
                    name="message"
                    placeholder="Add a custom message or leave blank for default reminder..."></textarea>
            </div>
