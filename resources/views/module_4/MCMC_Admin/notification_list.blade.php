    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
            <div>
                ...
                <p class="text-muted small mb-0">Admin notification center</p>
            </div>
        </div>
                            ...
                            <div>
                                <div class="mb-2">
                                    <span class="badge bg-primary mb-2">
                                        <i class="fas fa-bell me-1"></i> Admin Alert
                                    </span>
                                </div>
                                ...
                                <div class="text-muted small">
                                    ...
                                    @if($notification->inquiry)
                                     · <a href="{{ route('admin.inquiries.show', ['id' => $notification->inquiry_id]) }}" class="ms-2">
