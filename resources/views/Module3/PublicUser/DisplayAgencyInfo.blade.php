...
@section('title', 'My Assigned Agencies - Inquira')
    ...
    <div class="main-content">
        <div class="agency-container">
            ...
            <div class="breadcrumb">
                ...
                <span>My Assigned Agencies</span>
            </div>
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-card">
                            <div class="info-card-header">
                                ...
                                <h3>Your Inquiries with This Agency</h3>
                            </div>
                            <div class="info-card-content">
                                @php
                                    $relatedInquiries = $userInquiries->filter(function($inquiry) use ($agency) {
                                        return $inquiry->verificationProcesses->contains('staff_agency_id', $agency->agency_id);
                                    });
                                @endphp
                                ...
                                @if($relatedInquiries->count() > 0)
                                    @foreach($relatedInquiries as $inquiry)
                                        <div style="padding: 8px 0; border-bottom: 1px solid #e2e8f0;">
                                            <strong>#{{ $inquiry->inquiry_id }}</strong> {{ Str::limit($inquiry->title, 50) }}<br>
                                            <span style="font-size: 14px; color: #64748b;">
                                                Status: <span
                                                    class="badge {{ $inquiry->status == 'Pending' ? 'bg-warning' : ($inquiry->status == 'Resolved' ? 'bg-success' : 'bg-primary') }}"
                                    ...
                                    @endforeach
                                @else
                                    <p>No active inquiries with this agency.</p>
                                @endif
                            </div>
                        </div>
            ...
            @else
                <div class="no-agencies">
                    ...
                    <h3>No Assigned Agencies Found</h3>
                    <p>You don't have any inquiries assigned to agencies yet. Once MCMC staff assigns your inquiry to an agency,
                        you'll be able to see the agency's information here.</p>
                </div>
            @endif
